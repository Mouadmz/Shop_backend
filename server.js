...
const connectDb = async () => {
    await mongoose.connect('mongodb://127.0.0.1:27017/mabase', {useNewUrlParser: true, useUnifiedTopology : true}).then(
        () => {
...
const storepath = require('./routes/route');

//Acces the routes 
app.use('/api/v1/', storepath);
